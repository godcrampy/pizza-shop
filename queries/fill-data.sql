...
insert into food values(default, 80, "Margherita Pizza: 5 inch");
insert into food values(default, 100, "Margherita Pizza: 7 inch");
insert into food values(default, 120, "Margherita Pizza: 9 inch");
insert into food values(default, 120, "Deep Dish Pizza: 7 inch");
insert into food values(default, 150, "Deep Dish Pizza: 9 inch");
insert into food values(default, 100, "Napoli Pizza: 5 inch");
insert into food values(default, 120, "Napoli Pizza: 7 inch");
insert into food values(default, 150, "Napoli Pizza: 9 inch");

insert into food values(default, 50, "Coke small");
insert into food values(default, 100, "Coke medium");
insert into food values(default, 120, "Coke large");
